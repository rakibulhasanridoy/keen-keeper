    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
      ...
      <div className="mb-8 relative">
        <input
          ...
          className="w-full max-w-md px-4 py-2.5 pr-10 border border-[#d4e8d8] rounded-lg text-[#1a2e1e] placeholder-[#8a9e8f] focus:outline-none focus:ring-2 focus:ring-[#2d6a4f] focus:border-transparent"
        />
        <ChevronDown
          size={20}
          className="absolute right-3 top-1/2 -translate-y-1/2 text-[#8a9e8f] pointer-events-none"
        />
      </div>
